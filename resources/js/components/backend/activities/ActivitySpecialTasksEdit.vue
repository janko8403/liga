    ...
    <div class="row justify-content-center mt-3">
            ...
            <div class="card p-4">
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active" id="data-tab" data-bs-toggle="tab" data-bs-target="#data" type="button" role="tab" aria-controls="data" aria-selected="true">Edycje</button>
                    </li>
                    <li class="nav-item" role="presentation">
                ...
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade show active p-2" id="data" role="tabpanel" aria-labelledby="data-tab">
                        <div class="row justify-content-end">
                            <button class="btn btn-secondary" style="width:150px" @click="addNewActivitySpecialTaskEdition">Nowa edycja</button>
                        </div>
                        <ActivityEditions :activity="activity"></ActivityEditions>
                    </div>
        ...
        <div class="col-3">
            ...
            <div class="card mt-4">
                ...
                <div class="card-body">
                    <Files :activity_id="id" :file_type="file_type" />
                </div>
            </div>
...
export default {
    ...
    setup(props) {
        ...
        const { storeActivityEdition } = useActivityEditions()
        ...
        const addNewActivitySpecialTaskEdition = async() => {
            await storeActivityEdition()
            await nextTick();
        ...
        return {
            ...
            activity,
            file_type,
            addNewActivitySpecialTaskEdition,
            saveActivity,
            getAllPermissions,
            allPermissions,
            date,
