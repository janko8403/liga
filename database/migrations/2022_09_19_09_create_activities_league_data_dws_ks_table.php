...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('activities_league_data_dws_ks', function (Blueprint $table) {
            $table->id();
            $table->integer('activity_id')->nullable();
            $table->integer('edition_id')->nullable();
            $table->string('nepu')->nullable();
            $table->integer('njs_dws')->nullable();
            $table->string('dws')->nullable();
    ...
    {
        Schema::dropIfExists('activities_league_data_dws_ks');
    }
};
