...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('activities_league_data_dsk', function (Blueprint $table) {
            $table->id();
            $table->integer('activity_id')->nullable();
            $table->integer('edition_id')->nullable();
            $table->integer('nepu')->nullable();
            $table->string('miejsce')->nullable();
    ...
    {
        Schema::dropIfExists('activities_league_data_dsk');
    }
};
