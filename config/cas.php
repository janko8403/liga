...
return [
    ...
    */
    'cas_hostname' => env('CAS_HOSTNAME', 'zaloguj-pre.pzu.pl'),
    ...
    */
    'cas_real_hosts' => env('CAS_REAL_HOSTS', 'zaloguj-pre.pzu.pl'),
    ...
    */
    'cas_client_service' => env('CAS_CLIENT_SERVICE', 'https://ligabsr.pzu.pl'),
    ...
    */
    ...
    |--------------------------------------------------------------------------
    */
    'cas_logout_url' => env('CAS_LOGOUT_URL', 'https://zaloguj-pre.pzu.pl/wyloguj'),
    ...
    */
    'cas_redirect_path' => env('CAS_REDIRECT_PATH', 'https://ligabsr.pzu.pl/'),
